...
using CcAcca.LogEvents;

namespace CcAcca.AppInsights.Log4NetAppender
{
    /// <summary>
    ...
    public sealed partial class ApplicationInsightsAppender : AppenderSkeleton
    {
        ...
        {
            if (loggingEvent.MessageObject is LogEventInfo)
            {
        ...
        private static void BuildCustomProperties(LoggingEvent loggingEvent, ITelemetry trace)
        {
            ...
            AddLog4NetProperties(properties, metaData);
        }
